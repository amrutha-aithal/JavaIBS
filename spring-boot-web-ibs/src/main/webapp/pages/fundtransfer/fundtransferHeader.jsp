			...
			<c:choose>
				<c:when test="${role=='ADMIN' }">
					...
					<li class="nav-item "><a class="nav-link"
						href="/admin/bankservices">Bank Services</a></li>
					<li class="nav-item "><a class="nav-link" href="/signout">Sign
							Out</a></li>
				</c:when>
				<c:otherwise>
					<li class="nav-item"><a class="nav-link" href="/signin/home">Home</a>
					</li>
					<li class="nav-item active "><a class="nav-link"
						href="/fundtransfer">Fund Transfer</a></li>
					<li class="nav-item "><a class="nav-link"
						href="/fundtransfer/beneficiaryList">Beneficiaries</a></li>
					<li class="nav-item "><a class="nav-link"
						href="/fundtransfer/transactionsList">Statements</a></li>
