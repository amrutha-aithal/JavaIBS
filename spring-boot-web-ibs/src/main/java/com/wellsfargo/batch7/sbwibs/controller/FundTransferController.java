...
public class FundTransferController {
	...
	@GetMapping("/edit")
	public ModelAndView editBeneficiaryAction(HttpServletRequest request, @RequestParam("benefAccNum") long benefAccNum)
			throws IBSException {
	...
	public ModelAndView addBeneficiaryAction(@ModelAttribute("beneficiary") @Valid FundTransferModel beneficiary,
	...
	@PostMapping("/update")
	public ModelAndView updateBeneficiaryAction(@ModelAttribute("beneficiary") @Valid FundTransferModel beneficiary,
			BindingResult result) throws IBSException {
		ModelAndView mv = null;
	...
	public ModelAndView fundTransferAction(@ModelAttribute("fund") @Valid FundTransferModel fund, BindingResult result,
			HttpServletRequest request) throws IBSException {
	...
	public ModelAndView getAllTransactionAction(ModelAndView mv, HttpServletRequest request) throws IBSException {
		Principal principal = request.getUserPrincipal();
		String currentUserName = principal.getName();
		Object[] fund = fundTransferService.getAllTransactions(currentUserName).toArray();
		mv.setViewName("/fundtransfer/transactionsList");
		mv.addObject("accounts", accountService.getAllSavingsAccount(currentUserName));
		mv.addObject("fund", fund);
		return mv;
	}

	@GetMapping("/monthlyStatements")
