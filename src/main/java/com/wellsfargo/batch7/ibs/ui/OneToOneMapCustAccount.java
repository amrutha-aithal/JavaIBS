...
public class OneToOneMapCustAccount {
	...
	public static void main(String[] args) {
		Customer customer = new Customer(null, "user1", "pwd1", "Customer", "Rahul", "01/03/1985", "9984569711",
				"RT Nagar,Bangalore", "user1@gmail.com", "tcpwd1");
		LocalDate today = LocalDate.parse("2019-03-29");

		customer.setSavAccount(new Account("", "", 123.01, 1754.25, today, today, 123.2, 1.11, 1.11, 1.11, 2.2));
